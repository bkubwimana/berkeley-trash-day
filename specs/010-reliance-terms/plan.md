...
3. Gate report submission and collection/street-sweeping calendar actions; require the
   current version at the report API boundary and confirm at the moment of calendar use.
...
5. Store the version and server acceptance time with submitted reports while leaving
   calendar-file downloads local and unlogged.
